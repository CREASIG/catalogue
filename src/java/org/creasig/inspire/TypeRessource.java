 ...
 */
@Entity
@Table(name = "typeressource", catalog = "catalogue", schema = "public")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TypeRessource.findAll", query = "SELECT t FROM TypeRessource t")
    , @NamedQuery(name = "TypeRessource.findById", query = "SELECT t FROM TypeRessource t WHERE t.id = :id")
...
public class TypeRessource implements Serializable {
    ...
    public String toString() {
        return "org.creasig.inspire.TypeRessource[ id=" + id + " ]";
    }
